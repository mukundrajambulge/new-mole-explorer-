...
| trajectory data | Typed trajectory viewer for multi-frame XYZ/GRO; DCD/XTC/TRR explicit header/metadata-only status | AT-FSR-J-005; adapter tests | IMPLEMENTED_WITH_LIMITATIONS | Full binary frame decoding, topology pairing, and performance gates remain pending. |
