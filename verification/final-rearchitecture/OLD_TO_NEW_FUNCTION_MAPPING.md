...
| Sequence/maps/trajectories | File → Import dialog; typed center viewers | Biological adapter registry → sequence/map/trajectory/topology/SMILES viewers | PASS, bounded | AT-FSR-J-001–010; adapter tests; BIOLOGICAL_DATA.lock.json |
