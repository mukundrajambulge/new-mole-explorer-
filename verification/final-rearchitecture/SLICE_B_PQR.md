# Slice B — PQR coordinate adapter
...
Other requested file families remain explicitly unsupported until their appropriate model adapters and corpus acceptance tests exist.
