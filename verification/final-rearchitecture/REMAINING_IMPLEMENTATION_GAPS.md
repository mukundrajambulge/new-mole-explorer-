...
| --- | --- | --- |
| Biological formats | Coordinate objects remain PDB, mmCIF/CIF, PQR, SDF/MOL, bounded single-frame XYZ, MOL2, and PDBQT. FASTA/FASTQ/GenBank/EMBL, DX/MRC/CCP4, multi-frame XYZ, GRO, PSF, PRMTOP, and SMILES now route to typed dedicated viewers without coordinate fabrication. DCD, TRR, and XTC decode bounded coordinate frames. | Add larger corpus and performance gates; implement topology-coordinate pairing before making research trajectory claims. |
