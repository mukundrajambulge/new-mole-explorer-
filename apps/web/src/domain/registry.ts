...
export const ACTION_REGISTRY: Record<ActionId, ActionDefinition> = {
  ...
  [ACTION_IDS.FILE_IMPORT]: comingSoon(ACTION_IDS.FILE_IMPORT, "FILE", "Import structure", "Structure parsing and import are intentionally outside G0."),
  ...
  [ACTION_IDS.CANVAS_SELECT]: supported(ACTION_IDS.CANVAS_SELECT, "CANVAS", "Select canvas tool", "Presentation interaction state only."),
  ...
  [ACTION_IDS.REPRESENTATION_CARTOON]: comingSoon(ACTION_IDS.REPRESENTATION_CARTOON, "REPRESENTATION", "Cartoon", "Molecular representation requires authoritative coordinates."),
  [ACTION_IDS.REPRESENTATION_BALL_AND_STICK]: comingSoon(ACTION_IDS.REPRESENTATION_BALL_AND_STICK, "REPRESENTATION", "Ball & stick", "Molecular representation requires authoritative topology."),
  [ACTION_IDS.REPRESENTATION_LICORICE]: comingSoon(ACTION_IDS.REPRESENTATION_LICORICE, "REPRESENTATION", "Licorice", "Molecular representation requires authoritative topology."),
  [ACTION_IDS.REPRESENTATION_SPHERES]: comingSoon(ACTION_IDS.REPRESENTATION_SPHERES, "REPRESENTATION", "Spheres", "Molecular representation requires authoritative coordinates."),
  ...
  [ACTION_IDS.VIEW_THEME]: supported(ACTION_IDS.VIEW_THEME, "VIEW", "Toggle theme", "Presentation preference only."),
