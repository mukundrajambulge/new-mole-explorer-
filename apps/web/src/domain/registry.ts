...
export const ACTION_REGISTRY: Record<ActionId, ActionDefinition> = {
  ...
  [ACTION_IDS.MEASURE_DISTANCE]: comingSoon(ACTION_IDS.MEASURE_DISTANCE, "MEASURE", "Measure distance", "Distance measurement UI is available in the V2 interaction surface; the legacy registry remains marked for compatibility with the G1B capability contract."),
