...
type StructurePanelProps = {
  ...
  activeSelection: Pick<SelectionResult, "count" | "status" | "membershipHash" | "query" | "coordinateContext" | "presentationContext"> | null;
