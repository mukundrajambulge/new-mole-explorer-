...
const ribbonItems: Partial<Record<Exclude<RibbonCategory, "Color" | "Display">, RibbonItem[]>> = {
  ...
  Edit: [{ label: "Undo", icon: "undo", actionId: "HISTORY.UNDO" }, { label: "Redo", icon: "redo", actionId: "HISTORY.REDO", dividerAfter: true }, { label: "Delete atom", icon: "trash", actionId: "EDIT.ATOM_DELETE", capability: "Unavailable" }, { label: "Create bond", icon: "plus", actionId: "EDIT.BOND_CREATE", capability: "Unavailable" }],
