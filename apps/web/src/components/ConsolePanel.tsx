...
type ConsoleEntry = { category: "SYSTEM" | "SELECTION" | "PRESENTATION" | "MEASURE" | "OBJECT" | "VIEW" | "HISTORY" | "EDIT" | "ANALYSIS" | "CAPABILITY"; command: string; status: string; timestamp: string; count?: number; diagnostics?: readonly ConsoleDiagnostic[] };
