...
export const runAlign = (request: AlignmentRequest): StructuralAlignmentResult => run({ ...request, operationKind: "ALIGN", mappingMode: "SEQUENCE_GUIDED", compatibilityProfile: "pymol-5e8bfca:align", alignmentObjectRequested: request.alignmentObjectRequested }, { id: "PYMOL_ALIGN_PROFILE", operation: "ALIGN", mutatesCoordinates: request.transformRequested, compatibility: "pymol-5e8bfca:align" });
export const runSuper = (request: AlignmentRequest): StructuralAlignmentResult => run({ ...request, operationKind: "SUPER", mappingMode: "SEQUENCE_GUIDED", compatibilityProfile: "pymol-5e8bfca:super", refinementProfile: request.refinementProfile.cycles === 0 ? { ...request.refinementProfile, cycles: 5 } : request.refinementProfile }, { id: "PYMOL_SUPER_PROFILE", operation: "SUPER", mutatesCoordinates: request.transformRequested, compatibility: "pymol-5e8bfca:super" });
