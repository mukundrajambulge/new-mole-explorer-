...
const provenanceFor = (operation: string, profileId: string, inputDigests: readonly string[], informationLoss: D2ProvenanceRecordV1["informationLoss"]): D2ProvenanceRecordV1 => {
